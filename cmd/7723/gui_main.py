...
from bot7723_main import run_7723
...
class Bot7723GUI:
    def __init__(self, root):
        self.root = root
        self.root.title("7723 自动化采集助手 v1.0")
        ...
        self.log_dir = os.path.join(self.base_dir, 'logs', '7723')
    ...
    def setup_styles(self):
        ...
        style.map("TNotebook.Tab", background=[("selected", "#ff6b35")], foreground=[("selected", "white")])
        style.configure("TFrame", background="#1e1e1e")
        style.configure("TLabelframe", background="#1e1e1e", foreground="#ff6b35")
        style.configure("TLabelframe.Label", background="#1e1e1e", foreground="#ff6b35", font=("Microsoft YaHei UI", 10, "bold"))
    ...
    def setup_monitor_tab(self, parent):
        ...
        tk.Label(title_frame, text="📱 7723 自动化采集助手", font=("Microsoft YaHei UI", 20, "bold"), fg="#ff6b35", bg="#1e1e1e").pack()
        ...
        self.start_btn = tk.Button(btn_frame, text="▶ 启动", font=("Microsoft YaHei UI", 11, "bold"), bg="#ff6b35", fg="white", 
        ...
        self.log_text.tag_config("info", foreground="#ff6b35")
    ...
    def stop_process(self):
        ...
        self.is_running = False
        self.start_btn.configure(state=tk.NORMAL, bg="#ff6b35")
    ...
    def run_worker(self):
        try:
            run_7723(stop_func=lambda: not self.is_running)
        except Exception as e:
